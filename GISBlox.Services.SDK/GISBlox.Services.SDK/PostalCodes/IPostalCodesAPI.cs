...
namespace GISBlox.Services.SDK.PostalCodes
{
   ...
   public interface IPostalCodesAPI : IDisposable
   {
      ...
      Task<PostalCode6Record> GetPostalCode6Record(string id, int epsg = 28992, CancellationToken cancellationToken = default);
      ...
      /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
      /// <returns>A <see cref="PostalCode4Record"/> type.</returns>
      Task<PostalCode6Record> GetPostalCode6Neighbours(string id, bool includeSourcePostalCode = false, int epsg = 28992, CancellationToken cancellationToken = default);
      ...
      /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
      /// <returns>A <see cref="PostalCode6Record"/> type.</returns>
      Task<PostalCode6Record> GetPostalCode6ByGeometry(string wkt, int buffer = 0, int wktEpsg = 28992, int targetEpsg = 28992, CancellationToken cancellationToken = default);
      ...
      /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
      /// <returns>A <see cref="PostalCode4Record"/> type.</returns>
      Task<PostalCode6Record> GetPostalCode6ByGWB(int gemeenteId, int wijkId, int buurtId, int epsg = 28992, CancellationToken cancellationToken = default);
