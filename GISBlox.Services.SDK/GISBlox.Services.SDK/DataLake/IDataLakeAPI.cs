...
namespace GISBlox.Services.SDK.DataLake
{
   ...
   public interface IDataLakeAPI : IDisposable
   {
      ...
      /// <param name="cancellationToken">The cancellation token to use for the operation.</param>     
      /// <returns>True if successful, False if not.</returns>
      Task<bool> DownloadFile(string fileName, string localPath, CancellationToken cancellationToken = default);
      ...
      /// <param name="cancellationToken">The cancellation token to use for the operation.</param>
      /// <returns>True if successful, False if not.</returns>
      Task<bool> ExportFileAsGeoParquet(string fileName, string localPath, CancellationToken cancellationToken = default);
